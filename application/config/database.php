...
$database_url = getenv('DATABASE_URL') ?: 'postgresql://neondb_owner:npg_U6g5sCwXIPoZ@ep-noisy-bonus-a1n85050.ap-southeast-1.aws.neon.tech/ticket_system?sslmode=require&channel_binding=require&options=endpoint%3Dep-dry-hill-a12opvrh';
if ($database_url) {
